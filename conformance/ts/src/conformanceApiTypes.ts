...
export interface IConformanceApi {
  ...
  mirrorFields(request: IMirrorFieldsRequest): Promise<IServiceResult<IMirrorFieldsResponse>>;

  checkQuery(request: ICheckQueryRequest): Promise<IServiceResult<ICheckQueryResponse>>;

  checkPath(request: ICheckPathRequest): Promise<IServiceResult<ICheckPathResponse>>;

  mirrorHeaders(request: IMirrorHeadersRequest): Promise<IServiceResult<IMirrorHeadersResponse>>;

  mixed(request: IMixedRequest): Promise<IServiceResult<IMixedResponse>>;

  required(request: IRequiredRequest): Promise<IServiceResult<IRequiredResponse>>;
}
